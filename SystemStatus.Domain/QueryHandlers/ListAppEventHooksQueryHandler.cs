...
{
    public class ListAppEventHooksQueryHandler : IQueryHandler<ListAppEventHooksQuery, IEnumerable<AppEventHook>>
    {
        public IEnumerable<AppEventHook> Handle(ListAppEventHooksQuery query)
        {
