...
namespace SystemStatus.Domain
{
	...
	public class CommandValidationResult {
		...
		/// </remarks>
		public static readonly CommandValidationResult Success;
		...
		public CommandValidationResult(string errorMessage, IEnumerable<string> memberNames) {
		...
		protected CommandValidationResult(CommandValidationResult validationResult) {
